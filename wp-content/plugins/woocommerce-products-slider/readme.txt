...
== Changelog ==
    ...
    * 2023-03-07 fix - Settings page conflict issue fixed.
    ...
    = 1.13.43 =
    * 2023-03-07 fix - Font awesome icon issue for next-prev button
    * 2023-03-07 fix - Container padding margin conflict issue fixed.


    = 1.13.42 =
    * 2023-01-17 fix - Escape issue fixed.
    * 2023-01-17 fix - Layout screenshot issue fixed.


    = 1.13.41 =
    * 2023-01-15 fix - Thumnbnail max width size issue fixed.
    * 2023-01-15 fix - Slider navigation dots color issue fixed.
    * 2023-01-15 fix - Query products on-sale query set to no check.



    = 1.13.40 =
* 2023-01-15 fix - Escape issue fixed.

    = 1.13.39 =
* 2022-12-13 fix - default empty layout issue fixed.
